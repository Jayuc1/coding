 ...
 * Parameters:
 * @fmt: Function parameter 1
 * @list: Function parameter 2
 * @ind: Function parameter 3
 * @buffer: Function parameter 4
 * @flags: Function parameter 5
 * @width: Function parameter 6
 * @precision: Function parameter 7
 * @size: Function parameter 8
 * Return: 1 or 2;
 */
